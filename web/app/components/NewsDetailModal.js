...
export default function NewsDetailModal({
  ...
  const handleCopyIoCs = () => {
    const lines = [
      ...
      `1. Apply latest vendor security patches immediately.`,
      `2. Search internal SIEM / EDR logs for matched CVE and Tactics.`,
      `3. Verify backup immutability and credential posture.`,
      `---`,
